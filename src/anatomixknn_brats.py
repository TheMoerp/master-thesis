...
"""
create_unique_results_dir is provided by common.brats_preprocessing
"""
...
"""
subject_level_split is available from common.brats_preprocessing
"""
...
def threshold_from_normal(val_scores: np.ndarray, percentile: float) -> float:
    # Unsupervised: percentile on validation NORMAL scores
